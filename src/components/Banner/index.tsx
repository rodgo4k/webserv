      ...
      <div className="text_container">
        ...
        <div className="description_container">
          <div className="description">
            Tenha acesso a um desempenho excepcional com nossa infraestrutura de
            nível corporativo e proteção DDoS avançada, garantindo estabilidade,
            velocidade e segurança para seus serviços online.
          </div>
          <div className="description">
